...
-(void)loadResources {
    ...
    self.imgDismiss = [UIImage imageNamed:@"Reader/back" inBundle:bundle compatibleWithTraitCollection:nil];
    ...
    self.imgShare = [UIImage imageNamed:@"Reader/share" inBundle:bundle compatibleWithTraitCollection:nil];
}
...
-(void)prepareToolbar {
	...
	if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) { // Ipad.
        ...
        self.shareBarButtonItem = [[UIBarButtonItem alloc]initWithImage:self.imgShare style:UIBarButtonItemStylePlain target:self action:@selector(actionShare:)];
        [items addObject:self.shareBarButtonItem];
...
-(void)actionShare:(id)sender{
    ...
    activityVC.popoverPresentationController.sourceRect = CGRectMake(self.view.frame.size.width-70,20,50,50);
